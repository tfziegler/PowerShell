##################################################################
#
# Title: Delete All Hyper-V Checkpoints.ps1
# Author: Tom Ziegler
# Company: 
...
Get-VM 'DMZ - DMZDC2' | Remove-VMSnapshot -Name *
...
Get-VM 'SCLAB - DC2' | Remove-VMSnapshot -Name *
...
Get-VM 'SCLAB - OMMS3' | Remove-VMSnapshot -Name *
